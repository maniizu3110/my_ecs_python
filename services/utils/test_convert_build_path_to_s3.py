import unittest
from .convert_build_path_to_s3 import convert_to_s3_object_name


class TestConvertToS3ObjectName(unittest.TestCase):

    def test_convert_go_hey(self):
        self.assertEqual(convert_to_s3_object_name('./go/hey'), 'go-hey')

    def test_convert_build_path(self):
        self.assertEqual(convert_to_s3_object_name(
